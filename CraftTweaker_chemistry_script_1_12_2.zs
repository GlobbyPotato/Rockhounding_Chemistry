...
//voltage: the voltage multiplier to apply to the reaction (set zero for no voltage required)
...
CRUSHING GEARS
=======================================================
//input gear: the gear to be accepted inside the Mineral Sizer (must be a damageable item)
...
mods.rockhounding_chemistry.SlurryAgitators.add(<minecraft:diamond_shovel>);
