...
public class AnalyzerRecipes {
    ...
    @ZenMethod
    public static void addAll(IItemStack input, IItemStack[] output, int[] probability) {
        ...
        MineTweakerAPI.apply(new AddToAnalyzer(new MineralAnalyzerRecipe(CTSupport.toStack(input), outputs, probabilities)));
		    ...
		    private static class AddToAnalyzer implements IUndoableAction {
		    	...
		    	@Override
		    	public void apply() {
		    		ModRecipes.analyzerRecipes.add(this.recipe);
		    	...
		    	public void undo() {
		    		for(MineralAnalyzerRecipe recipe : ModRecipes.analyzerRecipes){
		    			if(recipe.equals(this.recipe)){
		    				...
		    				ModRecipes.analyzerRecipes.remove(recipe);	
	                        break;
		    			}
		    		}
		    	}
		    ...
		    private static class RemoveFromAnalyzer implements IUndoableAction {
		    	...
		    	public void undo() {
		    		if(this.undoRecipe != null){
			    		ModRecipes.analyzerRecipes.add(this.undoRecipe);
