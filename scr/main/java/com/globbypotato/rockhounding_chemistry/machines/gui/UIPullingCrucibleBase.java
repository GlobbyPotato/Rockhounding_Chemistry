...
public class UIPullingCrucibleBase extends GuiBase {
    ...
    private final TEPullingCrucibleBase tile;

    public UIPullingCrucibleBase(InventoryPlayer playerInv, TEPullingCrucibleBase tile){
    	super(new COPullingCrucibleBase(playerInv,tile), ModUtils.HEIGHT);
        GuiBase.TEXTURE = TEXTURE_REF;
        this.tile = tile;
		this.containerName = "container." + TEPullingCrucibleBase.getName();
    }
    ...
    public void drawScreen(int mouseX, int mouseY, float f) {
	   ...
	   //speed upgrade
	   if(GuiUtils.hoveringArea(149, 57, 18, 18, mouseX, mouseY, x, y)){
