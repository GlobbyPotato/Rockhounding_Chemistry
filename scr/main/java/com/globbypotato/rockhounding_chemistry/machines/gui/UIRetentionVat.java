...
public class UIRetentionVat extends GuiBase {
    ...
    private final TERetentionVat tile;

    public UIRetentionVat(InventoryPlayer playerInv, TERetentionVat tile){
    	super(new CORetentionVat(playerInv,tile), ModUtils.HEIGHT);
        GuiBase.TEXTURE = TEXTURE_REF;
        this.tile = tile;
		this.containerName = "container." + TERetentionVat.getName();
    }
