...
public class RendererPipelineValve extends TileEntitySpecialRenderer<TileEntityPipelineValve>{

	@Override
	public void renderTileEntityAt(TileEntityPipelineValve te, double x, double y, double z, float partialTicks, int destroyStage) {
