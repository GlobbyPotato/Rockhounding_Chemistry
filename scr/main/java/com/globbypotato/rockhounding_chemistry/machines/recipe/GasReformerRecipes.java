...
public class GasReformerRecipes extends BaseRecipes{
	...
	public static void machineRecipes() {
		...
		gas_reformer_recipes.add(new GasReformerRecipe(getFluid(EnumFluid.WATER_VAPOUR, 20), 		getFluid(EnumFluid.SYNGAS, 20), 			getFluid(EnumFluid.HYDROGEN, 20),		ni_catalyst));
		gas_reformer_recipes.add(new GasReformerRecipe(getFluid(EnumFluid.METHANOL, 20), 			getFluid(EnumFluid.HYDROGEN, 20), 			getFluid(EnumFluid.ACRYLIC_ACID, 20),	mo_catalyst));
	}
}