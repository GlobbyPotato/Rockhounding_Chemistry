...
public class ChemBook extends ItemWrittenBook {
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand){
		...
		itemStackIn = new ItemStack(Items.WRITTEN_BOOK);
			...
			bookPages.appendTag(new NBTTagString(ITextComponent.Serializer.componentToJson(new TextComponentString(
            			"ACID MAKING\n" 
					  + "Acids are required to manipulate the minerals through the various stages or for additional purposes. They are made in the Lab Oven by the reaction of a solute and one or two solvents."))));
            bookPages.appendTag(new NBTTagString(ITextComponent.Serializer.componentToJson(new TextComponentString(
            			"The Lab oven is powered by fuel which provides heat to the reaction and consumes redstone to eventually simulate an electrolysis process occurring for the reaction."))));
            bookPages.appendTag(new NBTTagString(ITextComponent.Serializer.componentToJson(new TextComponentString(
        				"Sulfuric Acid\n"
        			  + "Solute: Sulfur Comp.\n"
        			  + "Solvent: Water Tank\n"
