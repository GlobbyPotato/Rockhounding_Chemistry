...
public class CORetentionVatController extends ContainerBase<TERetentionVatController>{
	public CORetentionVatController(IInventory playerInventory, TERetentionVatController te) {
