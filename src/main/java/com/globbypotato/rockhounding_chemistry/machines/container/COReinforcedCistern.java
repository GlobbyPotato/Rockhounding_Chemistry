...
public class COReinforcedCistern extends ContainerBase<TEReinforcedCistern>{
	public COReinforcedCistern(IInventory playerInventory, TEReinforcedCistern te) {
	...
	public void addOwnSlots() {
		...
		this.addSlotToContainer(new SlotItemHandler(template, 1, 28, 47));//filter
	}
