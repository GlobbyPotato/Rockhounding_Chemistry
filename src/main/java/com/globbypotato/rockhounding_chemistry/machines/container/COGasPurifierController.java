...
public class COGasPurifierController extends ContainerBase<TEGasPurifierController>{
	public COGasPurifierController(IInventory playerInventory, TEGasPurifierController te) {
