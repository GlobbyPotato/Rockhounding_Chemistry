...
public class COGasCondenserController extends ContainerBase<TEGasCondenserController>{
	public COGasCondenserController(IInventory playerInventory, TEGasCondenserController te) {
