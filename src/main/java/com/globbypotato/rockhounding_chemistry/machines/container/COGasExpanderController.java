...
public class COGasExpanderController extends ContainerBase<TEGasExpanderController>{
	public COGasExpanderController(IInventory playerInventory, TEGasExpanderController te) {
	...
	public void addOwnSlots() {
		...
		this.addSlotToContainer(new SlotItemHandler(upgrade, 0, 105, 34));//speed
