...
public class ChemicalExtractor extends BaseTileBlock{
	...
	private void addNbt(ItemStack itemstack, TileEntity tileentity) {
		...
		itemstack.getTagCompound().setInteger("Fuel", ((TileEntityChemicalExtractor)tileentity).powerCount);
		itemstack.getTagCompound().setInteger("Energy", ((TileEntityChemicalExtractor)tileentity).redstoneCount);
	}
