...
public class LeachingVatRecipes extends BaseRecipes{
	...
	public static void machineRecipes(){
		...
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.ARSENATE), 
																		...
																		Arrays.asList(2.5F), getFluid(EnumFluid.LOW_LEACHATE, 1000)));
		//borate vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.BORATE), 
																		...
																		Arrays.asList(1.71F, 3.22F, 4.3F, 3.34F, 3.44F), getFluid(EnumFluid.LOW_LEACHATE, 1000)));
		//carbonate vat 1
		...
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.HALIDE), 
																		...
																		Arrays.asList(4.94F, 1.6F, 2.3F, 2.69F, 2.71F), getFluid(EnumFluid.LOW_LEACHATE, 1000)));
		//native vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.NATIVE),
																		...
																		Arrays.asList(5.12F, 7.7F, 14.9F, 13.44F, 15.46F, 11.50F, 4.42F, 1.95F, 3.38F, 2.16F, 22F), getFluid(EnumFluid.HIGH_LEACHATE, 1000)));
		//oxide vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.OXIDE), 
																		...
																		Arrays.asList(4.79F, 6.3F, 6.9F, 3.03F, 4.3F, 5.3F, 5.82F, 7.08F, 1.92F, 3.01F, 5.50F, 7.3F, 7.45F, 8.77F, 6.3F, 4.25F, 8.72F, 5.96F), getFluid(EnumFluid.HIGH_LEACHATE, 1000)));
		//phosphate vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.PHOSPHATE), 
																		...
																		Arrays.asList(2.92F, 3.05F, 2.89F, 3.5F, 2.34F, 4.75F, 4.37F, 3.71F, 3.28F, 3.61F, 3.86F, 1.88F), getFluid(EnumFluid.LEACHATE, 1000)));
		//silicate vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.SILICATE), 
																		...
																		Arrays.asList(3.82F, 3.09F, 3.41F, 2.67F, 2.95F, 2.89F, 3.67F, 2.25F, 2.98F, 4.08F, 7.1F, 4.65F), getFluid(EnumFluid.HIGH_LEACHATE, 1000)));
		//sulfate vat 1
		...
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.SULFIDE),
																		...
																		Arrays.asList(6.44F, 6.31F, 7.4F, 4.56F, 4.8F, 5.01F, 4.4F, 3.11F, 4.61F, 7.68F, 9.59F, 7.4F, 4.49F, 4.77F, 4F, 2.82F, 5.79F, 7.3F), getFluid(EnumFluid.HIGH_LEACHATE, 1000)));
		//vanadate vat 1
		leaching_vat_recipes.add(new LeachingVatRecipe(mineral_ores(1,EnumMinerals.VANADATE),
																		...
																		Arrays.asList(2.38F, 2.90F, 2.45F), getFluid(EnumFluid.LOW_LEACHATE, 1000)));
	}
