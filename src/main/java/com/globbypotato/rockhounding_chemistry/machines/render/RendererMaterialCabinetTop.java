...
public class RendererMaterialCabinetTop extends TileEntitySpecialRenderer<TEMaterialCabinetTop>{

	@Override
	public void render(TEMaterialCabinetTop te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
