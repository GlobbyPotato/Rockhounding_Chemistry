...
public class RendererGaslinePump extends TileEntitySpecialRenderer<TEGaslinePump>{

	@Override
	public void render(TEGaslinePump te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
