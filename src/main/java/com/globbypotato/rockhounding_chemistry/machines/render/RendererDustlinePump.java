...
public class RendererDustlinePump extends TileEntitySpecialRenderer<TEDustlinePump>{

	@Override
	public void render(TEDustlinePump te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
