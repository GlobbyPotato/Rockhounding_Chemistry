...
public class RendererExtractorBalance extends TileEntitySpecialRenderer<TEExtractorBalance>{

	@Override
	public void render(TEExtractorBalance te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		...
		if(te != null){
			...
			if(!te.mainSlot().isEmpty()){
				ItemStack slotSack = te.mainSlot().copy();
			...
			if(!renderStack.isEmpty()){
				...
				GlStateManager.pushMatrix();
				{
					...
					GlStateManager.translate(0.50, 0.1, 0.50);
