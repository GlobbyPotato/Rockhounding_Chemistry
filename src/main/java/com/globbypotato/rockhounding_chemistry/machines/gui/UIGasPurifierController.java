...
public class UIGasPurifierController extends GuiBase {
    ...
    private final TEGasPurifierController tile;

    public UIGasPurifierController(InventoryPlayer playerInv, TEGasPurifierController tile){
    	super(new COGasPurifierController(playerInv,tile), ModUtils.HEIGHT);
        GuiBase.TEXTURE = TEXTURE_REF;
        this.tile = tile;
		this.containerName = "container." + TEGasPurifierController.getName();
    }
    ...
    public void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY){
        ...
        if (this.tile.getCooktime() > 0){
            ...
            int p = GuiUtils.getScaledValue(43, this.tile.getCooktime(), this.tile.getCooktimeMax());
            this.drawTexturedModalRect(i + 70, j + 33, 176, 32, 36, p);

            int k = GuiUtils.getScaledValue(59, this.tile.getCooktime(), this.tile.getCooktimeMax());
