...
public class UIGasExpander extends GuiBase {
    ...
    private final TEGasExpander tile;

    public UIGasExpander(InventoryPlayer playerInv, TEGasExpander tile){
    	super(new COGasExpander(playerInv,tile), ModUtils.HEIGHT);
        GuiBase.TEXTURE = TEXTURE_REF;
        this.tile = tile;
		this.containerName = "container." + TEGasExpander.getName();
    }
