...
public class TEPullingCrucibleTop extends TileEntityInv {
	...
	//----------------------- STRUCTURE -----------------------
	//base
		public TEPullingCrucibleController getBase(){
			TileEntity te = this.world.getTileEntity(this.pos.down());
			if(this.world.getBlockState(this.pos.down()) != null && te instanceof TEPullingCrucibleController){
				TEPullingCrucibleController injector = (TEPullingCrucibleController)te;
