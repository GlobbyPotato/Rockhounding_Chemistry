...
public class TEFluidpedia extends TileEntityInv {
	...
	public static int templateSlots = 67;
	...
	public TEFluidpedia() {
		...
		this.template =  new MachineStackHandler(templateSlots, this){
			...
			public void validateSlotIndex(int slot){
				if(upgrade.getSlots() < templateSlots){
					NonNullList<ItemStack> stacksCloned = stacks;
					upgrade.setSize(templateSlots);
	...
	public void collectFluids(String chars, int views) {
		...
		Collections.sort(FLUID_LIST, new NameComparator());
	...
	public class NameComparator implements Comparator<Fluid>{
