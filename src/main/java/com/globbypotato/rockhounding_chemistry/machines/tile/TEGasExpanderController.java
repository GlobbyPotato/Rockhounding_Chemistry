...
public class TEGasExpanderController extends TileEntityInv {
	public static final int SPEED_SLOT = 0;

	public static int upgradeSlots = 1;
	public static int templateSlots = 1;

	public TEGasExpanderController() {
...
//centrifuge
	public TECentrifuge getCentrifuge(){
		TECentrifuge centrifuge = TileStructure.getCentrifuge(this.world, this.pos.offset(getFacing()), getFacing());
...
//output vessel 
	public TileVessel getOutTank(){
		TileVessel vessel = TileStructure.getHolder(this.world, this.pos.offset(getFacing(), 2), getFacing());
