...
public class TEAirCompressor extends TileEntityPoweredVessel {
	...
	public TileVessel getVessel(){
		TileVessel vessel = TileStructure.getHolder(this.world, this.pos.offset(getFacing()), getFacing());
	...
	private boolean canCompress() {
		return hasPower() && canFillAir();
	}

	private boolean canFillAir() {
		return hasVessel() && this.output.canSetOrFillFluid(getVessel().inputTank, getVessel().inputTank.getFluid(), compressedAir());
	}
