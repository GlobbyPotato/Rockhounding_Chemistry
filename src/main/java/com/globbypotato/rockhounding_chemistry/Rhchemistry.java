...
@Mod(modid = Reference.MODID, name = Reference.NAME, version = Reference.VERSION, dependencies = "required-after:rockhounding_core@[3.26,); required-after:bookshelf@[2.3,); required-after:gbook@[2.9,); required-after:redstoneflux@[2.0.1,);")
