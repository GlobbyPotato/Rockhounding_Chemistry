...
//------- ITEMS -------
    ...
    public static String[] 	miscItemsArray = new String[] 		{"logicChip", "cabinet", "ironNugget", "bowBarrel", "bowWheel", "fluidCan", "memoryChip", "coringChip", "setupChip", "crawlerCase", 
    															 "crawlerHead", "crawlerArm", "wrench", "flask", "yagRod", "resonator", "heater", "inductor", "cupronickelFoil", "copperCoil",
    															 "stator", "rotor", "arm", "fan", "nimonicFoil", "copperIngot", "energyCell", "leadIngot", "owcCasing", "sulfuricBeaker"};
...
//------- BLOCKS -------
    public static String[] 	owcBlocksArray = new String[] 	 	{"bulkhead", "concrete", "duct", "turbine", "valve", "generator", "storage", "inverter", "deflectora", "deflectorb", "deflectorc", "deflectord"};
